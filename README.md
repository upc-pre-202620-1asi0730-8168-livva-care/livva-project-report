...
Las Style Guidelines de Livva establecen los lineamientos visuales y comunicacionales que orientarán el diseño del Landing Page y de la Web Application. Su propósito es mantener una experiencia coherente entre ambos productos digitales y facilitar que los usuarios reconozcan y comprendan la información presentada durante su interacción con la plataforma.

Debido a que Livva se encuentra orientada a la intermediación y gestión de seguros vehiculares y de vida, la propuesta visual buscará transmitir principalmente confianza, claridad, seguridad y cercanía. Asimismo, se priorizará una comunicación comprensible, evitando el uso innecesario de términos complejos y manteniendo consistencia en los elementos visuales e interactivos.

Las decisiones generales relacionadas con branding, tipografía, colores, espaciado y tono de comunicación se especifican en las General Style Guidelines. Por otro lado, las Web Style Guidelines establecen los criterios visuales y de interacción aplicables específicamente al Landing Page y a la Web Application responsive.

### 4.1.1. General Style Guidelines

#### a. Branding

La identidad visual de Livva busca transmitir confianza, claridad, seguridad y cercanía. Debido a que la plataforma está orientada a la intermediación y gestión de seguros vehiculares y de vida, se prioriza una apariencia moderna, profesional y sencilla que facilite la comprensión de la información.

Los principales atributos de la marca son:

- **Confianza:** transmitir seguridad durante los procesos relacionados con seguros y protección.
- **Claridad:** presentar información comprensible y evitar complejidad visual innecesaria.
- **Cercanía:** mantener una comunicación amigable y orientativa.
- **Simplicidad:** utilizar interfaces limpias que permitan identificar fácilmente las acciones principales.
- **Consistencia:** mantener una experiencia visual uniforme entre el Landing Page y la Web Application.

#### b. Logotipo

El logotipo de Livva constituye uno de los principales elementos de identificación de la plataforma. Su uso debe mantenerse consistente en las diferentes vistas y productos digitales.

En la implementación actual, el identificador de Livva utiliza un estilo tipográfico con un tamaño de `28px`, peso `700` y una combinación entre un tono oscuro y el color azul principal de la marca.

Se debe conservar una adecuada legibilidad y evitar modificaciones arbitrarias en sus proporciones, colores o distribución.

#### c. Tipografía

La familia tipográfica principal utilizada por Livva es **Poppins**, con una fuente `sans-serif` como alternativa.

La selección busca mantener una apariencia moderna y facilitar la lectura de información relacionada con pólizas, coberturas, solicitudes, beneficiarios y otros elementos del dominio asegurador.

Principales niveles tipográficos:

- **Título principal del Hero:** 42px.
- **Títulos de sección:** 34px.
- **Logotipo:** 28px, peso 700.
- **Títulos de cards o planes:** 20px – 24px.
- **Texto introductorio:** 17px – 18px.
- **Texto de contenido:** 15px – 16px.
- **Etiquetas de sección:** 14px, peso 700.
- **Botones:** peso 600.
- **Enlaces de navegación:** peso 500.

En dispositivos móviles, los tamaños se reducen para mantener una adecuada legibilidad. Por ejemplo, el título principal pasa de `42px` a `34px` y los títulos de sección de `34px` a `28px`.

#### d. Paleta de colores

Livva utiliza principalmente una combinación de tonos azules y colores neutros.

El azul se emplea para destacar acciones principales, botones, enlaces y elementos interactivos, mientras que los tonos oscuros se utilizan en títulos y componentes de mayor jerarquía visual.

| Uso | Color | Código |
|---|---|---|
| Primary | Azul principal | `#2563EB` |
| Primary Hover | Azul oscuro | `#1D4ED8` |
| Headings | Azul oscuro profundo | `#0F172A` |
| Secondary Dark | Azul grisáceo oscuro | `#1E293B` |
| Body Text | Gris oscuro | `#333333` |
| Secondary Text | Gris azulado | `#475569` |
| Muted Text | Gris azulado claro | `#64748B` |
| Light Text | Gris claro | `#94A3B8` |
| Primary Background | Blanco | `#FFFFFF` |
| Secondary Background | Gris muy claro | `#F8FAFC` |
| General Background | Gris claro | `#F8F9FA` |
| Hero Background | Azul muy claro | `#EFF6FF` |
| Borders | Gris claro | `#E2E8F0` |
| Form Borders | Gris azulado claro | `#CBD5E1` |
| Focus State | Azul claro | `#BFDBFE` |

El color `#2563EB` constituye el principal color de identidad dentro de la interfaz.

#### e. Spacing

El sistema de espaciado de Livva busca mantener una interfaz ordenada y facilitar la separación visual entre grupos de información.

Los principales criterios utilizados son:

- Contenedor principal con ancho máximo de `1200px`.
- Padding horizontal general de `20px`.
- Padding horizontal de `16px` en dispositivos móviles.
- Secciones principales con aproximadamente `90px` de padding vertical.
- Hero Section con `80px` de padding vertical en desktop.
- Separaciones entre elementos de aproximadamente `10px` a `30px`.
- Gaps entre componentes y grids de aproximadamente `20px` a `50px`.
- Padding interno de cards y formularios de aproximadamente `24px` a `40px`.

Los elementos también utilizan bordes redondeados para mantener consistencia visual:

- Botones: `6px`.
- Inputs: `8px`.
- Cards: `14px` – `16px`.
- Toggles y badges: bordes completamente redondeados.

#### f. Tone of Voice

La comunicación de Livva mantiene un tono claro, profesional, respetuoso y sereno.

Debido a que la plataforma presenta información relacionada con protección, pólizas, coberturas, siniestros e indemnizaciones, se evita utilizar lenguaje ambiguo, excesivamente informal o alarmista.

Las principales dimensiones del tono son:

- **Serious over Funny:** se prioriza una comunicación seria, manteniendo un lenguaje cercano.
- **Formal over Casual:** se utiliza un tono moderadamente formal y comprensible.
- **Respectful over Irreverent:** la comunicación mantiene respeto hacia el usuario.
- **Calm over Enthusiastic:** se prioriza un tono sereno y orientativo, especialmente en situaciones relacionadas con siniestros o indemnizaciones.

### 4.1.2. Web Style Guidelines

#### a. Estructura de la página

La experiencia web de Livva está organizada mediante una estructura visual consistente que permite diferenciar claramente las principales secciones del Landing Page y facilitar la navegación del usuario.
...
- **Altura mínima:** `70px`.
- **Fondo:** blanco (`#FFFFFF`).
- **Comportamiento:** sticky, permaneciendo visible durante el desplazamiento.
- **Contenido:** logotipo, menú de navegación y botones de acción.
- **Enlaces:** utilizan tonos gris azulados y cambian al azul principal al realizar hover.

##### Hero Section

- Ocupa la sección principal de bienvenida.
- Utiliza una distribución de dos columnas en desktop.
- Presenta el mensaje principal, contenido descriptivo y llamadas a la acción.
- Utiliza un fondo degradado entre `#EFF6FF` y `#FFFFFF`.
- En dispositivos móviles la estructura pasa a una sola columna.

##### Services

- Presenta los principales servicios mediante cards.
- Utiliza una distribución de dos columnas en desktop y una columna en dispositivos móviles.
- Las cards utilizan fondo blanco, borde `#E2E8F0` y border-radius de `14px`.
- Al realizar hover se aplica desplazamiento vertical y sombra.

##### Plans

- Presenta los planes disponibles mediante cards.
- El plan destacado utiliza un borde azul de `2px`.
- Los precios utilizan mayor jerarquía visual.
- Se incluye un toggle para alternar entre opciones de facturación.

##### About

- Utiliza una estructura de dos columnas en desktop.
- Presenta información institucional y características principales.
- Algunos elementos utilizan una línea lateral azul para destacar contenido.

##### Contact

- Utiliza una estructura de dos columnas.
- Incluye información de contacto y formulario.
- Los campos utilizan bordes claros y un estado de focus azul.

##### Footer

- Utiliza fondo `#0F172A`.
- Incluye información de marca, enlaces y contenido complementario.
- Los enlaces utilizan colores de menor contraste y cambian a blanco durante hover.

#### b. Diseño de interfaz

La interfaz de Livva sigue principios de Responsive Web Design para mantener una experiencia adecuada en diferentes tamaños de pantalla.

Se utilizan dos breakpoints principales:

- **Hasta 900px:** los principales layouts pasan progresivamente de varias columnas a una sola columna.
- **Hasta 600px:** se utiliza una distribución principalmente vertical, se reducen tamaños tipográficos y los botones principales pueden ocupar todo el ancho disponible.
...
- Adaptación entre desktop y mobile.
- Contraste suficiente entre textos, fondos y elementos interactivos.

#### c. Tipografía Web

La interfaz utiliza **Poppins** como tipografía principal.
...
- **Plan Heading:** 24px.
- **Service Heading:** 20px.
- **Hero Paragraph:** 18px.
- **Section Paragraph:** 17px.
- **Body Text:** 15px – 16px.
- **Section Labels:** 14px.
- **Buttons:** peso 600.
- **Navigation:** peso 500.

En mobile los títulos principales se reducen para conservar legibilidad y evitar saturación visual.
...
- Padding base de `10px 24px`.
- Peso tipográfico `600`.
- Transiciones de `0.3s`.

Tipos principales:

- **Primary Button:** fondo `#2563EB` y texto blanco.
- **Primary Hover:** fondo `#1D4ED8`.
- **Outline Button:** borde azul, fondo transparente y texto azul.
- **Secondary Button:** estilo outlined.
- **Large Button:** padding de `12px 28px`.

En dispositivos móviles, determinados botones principales pueden ocupar el ancho completo disponible.
...
- Ancho del `100%`.
- Padding de `12px 14px`.
- Border-radius de `8px`.
- Borde de `1px solid #CBD5E1`.
- Tamaño de fuente de `15px`.

Durante el estado focus:

- Borde principal: `#2563EB`.
- Outline: `#BFDBFE`.

#### f. Cards

Las cards utilizadas en servicios, planes y otras secciones mantienen:

- Fondo blanco.
- Bordes suaves.
- Border-radius entre `14px` y `16px`.
- Espaciado interno consistente.
- Sombras ligeras para diferenciar jerarquías.
- Efectos hover en componentes interactivos.

#### g. Colores Web

Los principales colores utilizados en la experiencia web son:
...
La interfaz de Livva está diseñada para adaptarse a desktop, tablet y mobile.

En pantallas menores a `900px`:

- Los layouts principales pasan a una sola columna.
- La navegación puede reorganizarse.
- Los elementos se centran cuando es necesario.

En pantallas menores a `600px`:

- Los grids pasan a una sola columna.
- Los botones principales pueden ocupar todo el ancho.
- Los títulos reducen su tamaño.
- Los formularios utilizan menor padding.
- La navegación y el footer adoptan una distribución vertical.
